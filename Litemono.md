...
## train -litemono
>CUDA_VISIBLE_DEVICES=6,7 python train.py --model_name "run2_litemono_base" --model "lite-mono" --log_dir "/home/yxy/lgw/Lite-Mono/allrun" --data_path "/home/yxy/lgw/split_data/" --dataset "custom" --split "custom" --height 480 --width 640 --batch_size 28 --num_epochs 40 --lr 0.0001 5e-6 31 0.0001 1e-5 31 --mypretrain "/home/yxy/lgw/Lite-Mono/weights/lite-mono-pretrain.pth"
